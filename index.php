...
<body>
    ...
    <section id="sideber" class="sideber">
        <ul class="sideber__ber">
            <h3 class="sideber__panel"> Pharmacy Management System</h3>
    ...
    echo " active";
                ...
                <a href="index.php?id=allManager"><i id="left" class="fas fa-user"></i>All Managers</a>
            </li>
    ...
    echo " active";
                ...
                <a href="index.php?id=allPharmacist"><i id="left" class="fas fa-user"></i>All Pharmacists</a>
            </li>
    ...
    echo " active";
                ...
                <a href="index.php?id=allSalesman"><i id="left" class="fas fa-user"></i>All Salesmans</a>
            </li>
        </ul>
